...
type baseChart interface {
	...
	Dots() (ns []*elements.Dot)
	Edges() (es []elements.Edge)
	Bars() (rs []*elements.Bar)
	Boxes() (bs []*elements.Box)
	Candles() (cs []*elements.Candle)
	Labels() (ls []*elements.Label)
	Area() (r *elements.Area)
	Objects() (obj []fyne.CanvasObject)
